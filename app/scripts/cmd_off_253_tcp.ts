...
const IP = process.env.CMD_IP || "192.168.1.248";   // set to CAT-253 IP from the services map
const PORT = Number(process.env.CMD_PORT || "4445");// set to CAT-253 Port from the services map
